...
! mosaic-specific parameters
      ...
      integer, parameter :: ngas_soa = 12	! volatile soa species that have a gaseous counterpart
      integer, parameter :: ngas_volatile = ngas_ioa + ngas_soa
      integer, parameter :: naer = 23	! num of chemical species per bin (inorg + org)
      integer, parameter :: naercomp= 30+4+4	! num of electrolytes + oc, bc, and oin
...
! gas
      integer, save ::   &
       ih2so4_g,     ihno3_g,     ihcl_g,      inh3_g,    imsa_g,  &
       iaro1_g,      iaro2_g,     iaro3_g,     iaro4_g,   ialk1_g, &
       iole1_g,      iapi1_g,     iapi2_g,     iapi3_g,   iapi4_g, &
       ilim1_g,      ilim2_g
...
! aerosol generic
      integer, save ::   &
       ...
       ioin_a,     iaro1_a,    iaro2_a,   iaro3_a,    iaro4_a,   &
       ialk1_a,    iole1_a,    iapi1_a,   iapi2_a,    iapi3_a,   &
       iapi4_a,    ilim1_a,    ilim2_a
...
! aerosol elecctrolytes/compounds
      integer, save ::   &
       ...
       jaro3,      jaro4,      jalk1,      jole1,      japi1,    &
       japi2,      japi3,      japi4,      jlim1,                &
       jlim2,      jh2o
...
! MOSAIC physico-chemical constants
      ...
      real(r8), save ::      				&
      		...
      		conv2a,   				&
      		conv2b,   				&
		accom(ngas_volatile),   		&  ! mass accomodation coefficient
