...
!
	use module_data_mosaic_main, only:  &
	    ...
	    kso4_a, kno3_a, kcl_a, knh4_a, koc_a, kbc_a, karo1_a, kapi1_a, &
	    kapi3_a, kapi4_a, klim1_a, klim2_a,  &
	    kapi, kapi1, kapi2, kapi3, kapi4, klim, klim1, &
	...
	use module_data_mosaic_aero, only:  &
	    ...
	    iso4_a, ino3_a, icl_a, inh4_a, ioc_a, ibc_a, iaro1_a, iapi1_a, &
	    iapi2_a, iapi3_a, iapi4_a, ilim1_a, ilim2_a
...
!	  write(lun,'(/f10.1, a)') time_sec/60, 'min'
	  write(lun,'(/a,16(a,7x))') '     time      bin s   dcen   ', 'ntot', 'mdry', 'mh2o', &
	        ...
	        aer_name(iapi1_a)(1:4),aer_name(iapi2_a)(1:4),&
	        aer_name(iapi3_a)(1:4),aer_name(iapi4_a)(1:4),&
		  aer_name(ilim1_a)(1:4), 'SOAt'
...
!		    tmpa = 1.0/dlog10dp		! use this to report num and masses/dlog10dp
		...
		xmass(i,iapi1_a)*tmpa, xmass(i,iapi2_a)*tmpa, &
		xmass(i,iapi3_a)*tmpa, xmass(i,iapi4_a)*tmpa, &
		xmass(i,ilim1_a)*tmpa, sum(xmass(i,6:17))*tmpa
...
! output total number and species masses (summed over all bins)
	...
	write(lun,'(f10.1,1p,13e11.3)') time_sec/60.0, &
		...
		xmass(i,iapi1_a), xmass(i,iapi2_a), &
		xmass(i,iapi3_a), xmass(i,iapi4_a), &
		xmass(i,ilim1_a), sum(xmass(i,6:17))
...
! h2so4=1    hno3=2    nh3=4    no2=6    o3=11    so2=18    hcho=23
	...
	write(lun,'(2x,19(a,7x))') &
	    'time_min', &
	    species(koh)(1:4), species(ko3)(1:4), species(kapi)(1:4), &
	    species(kapi1)(1:4), species(kapi2)(1:4), &
	    species(kapi3)(1:4), species(kapi4)(1:4), &
	    species(klim)(1:4), species(klim1)(1:4), &
...
!	write(lun,'(/f10.1,a,5x,a,i3.3)') time_sec, ' = time', 'mosaic_box fort.', lun
	...
	write(lun,'(f10.1, 2x, 19e11.3)') &
          time_sec/60.0, &
	    cnn(koh)*tmpa, cnn(ko3)*tmpa, cnn(kapi)*tmpa, &
	    cnn(kapi1)*tmpa, cnn(kapi2)*tmpa, &
	    cnn(kapi3)*tmpa, cnn(kapi4)*tmpa, &
	    cnn(klim)*tmpa, cnn(klim1)*tmpa, &
