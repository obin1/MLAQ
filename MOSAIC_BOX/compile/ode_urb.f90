...
! SOA (revised code on 11/25/2011)
      p_urb(iaro1)= yield_factor*0.039*(r_urb(15)+r_urb(16)+r_urb(18)+r_urb(19))	! revised
      d_urb(iaro1)= 0.0

      p_urb(iaro2)= yield_factor*0.0108*(r_urb(15)+r_urb(16)+r_urb(18)+r_urb(19))	! revised
      d_urb(iaro2)= 0.0
...
! 25% of PAR is assumed to be associated with C > 8 carbon atoms, which produces SOA
      p_urb(ialk1)= yield_factor*0.25*.048*r_urb(1)
      d_urb(ialk1)= 0.0

      p_urb(iole1)= yield_factor*0.008*(r_urb(9)+r_urb(10)+r_urb(11)+r_urb(12)+   &	! revised
                          r_urb(13)+r_urb(14))
      d_urb(iole1)= 0.0
